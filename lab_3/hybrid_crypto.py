...
def generate_keys(symmetric_key_path: str,
    ...
    1. Генерирует симметричный ключ (ChaCha20) и nonce
    2. Генерирует пару RSA-ключей
    3. Зашифровывает симметричный ключ публичным ключом RSA
    4. Сохраняет все ключи в файлы
    """
...
def encrypt_data(initial_file_path: str,
    ...
    1. Загружает зашифрованный симметричный ключ и расшифровывает его (RSA)
    2. Загружает nonce
    3. Шифрует исходный файл ChaCha20
    """
