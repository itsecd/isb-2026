def read_text_file(initial_text_file):
        """
...
def write_encrypt_text(file_name, iv, c_text):
        """
...
def read_encrypt_text(encrypted_text_file):
        """
        ...
        return:
                tuple(iv, c_text): tuple with initialization vector (16 random bytes) and encrypted text in bytes 
        """
...
def write_decrypt_text(file_name, unpadded_dc_text):
        """
