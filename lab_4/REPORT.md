...
- `file_utils.py` — загрузка настроек из файла `settings.json`
...
Наиболее стабильные результаты показывают алгоритмы **SHA3-256** и **SHA3-512**, где разброс значений минимален и наиболее близок к 50%.
