def create_atbash_mapping() -> dict:
...
if __name__ == '__main__':
    ...
    #process_file('lab-1.1_text.txt', 'encrypted.txt', mode='encrypt')
    # Для расшифровки:
    process_file('encrypted.txt', 'decrypted.txt', mode='decrypt')
