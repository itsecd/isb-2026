...
def main() -> None:
    ...
    # --- B) Runs ---
    print("\n[2/3] Тест на одинаковые подряд идущие биты (Runs)...")
    ...
    # --- C) Longest Run ---
    print("\n[3/3] Тест на самую длинную последовательность единиц в блоке (Longest Run)...")
    ...
    print("Посчитайте P-value (igamc(a, x)) в онлайн-калькуляторе и вставьте сюда.")
    ...
    write_text(os.path.join(args.out_dir, "summary.txt"), summary)
    print(f"\nСводка сохранена в файл: {os.path.join(args.out_dir, 'summary.txt')}")
