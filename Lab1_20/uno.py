...
def list_files_in_directory():
    """Показываем список текстовых файлов в текущей директории с их размером"""
...
def main():
    ...
    while True:
        ...
        if choice == '3':
        ...
        elif choice == '2': #можно перезаписывать код в файлы
            ...
            if write_to_file(output_file, encrypted_text):
                ...
                print("\nПроверка расшифровки (используем тот же ключик со знаком минус):")# Теперь код не фемели френдли 😞
            ...
            print("НЕПРАУИЛЬНЫЙ ВЫБОР!!!. Выберите 1, 2 или 3.")
