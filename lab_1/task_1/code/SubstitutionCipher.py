...
def encryptMessageSubstitution(key, alphabet, message)->str:
    ...
    '''
    return translateMessageSub(key, alphabet, message, 'encrypt')
...
def decryptMessageSubstitution(key, alphabet, message)->str:
    ...
    '''
    return translateMessageSub(key, alphabet, message, 'decrypt')

def translateMessageSub(key, alphabet, message, mode)->str:
