...
1. Закодировать любой связный текст (не менее 500 символов), любым произвольным шифром простой подстановки (моноалфавитная замена) или перестановки. Дешифровать, чтобы проверить корректность работы алгоритма. 
...
- таблица частот для символов зашифрованного задания 2,
...
Варианты заданий и теоретическая информация приведены в [методичке](https://github.com/itsecd/isb-2026/blob/main/docs/ISB_Lab1.pdf).
